...
// 속성들을 props(properties) 형태로 props 라고 표현한다 했는데,
// 실제로 SocialLoginButton 컴포넌트가 사용하는 파라미터를 Props 형태로 표현하기 위해 작성
interface Props {
    provider: Provider;
    // 입력도없고, 리턴도 없는 함수가 onClick 입니다 라는 뜻
    // void (*)(void);
    onClick: () => void;
}

// 위의 Provider 에서 지정한 kakao, google, github 등이 오면,
...
// 파라미터 2개(provider 와 onClick 함수) 를 받아옴
