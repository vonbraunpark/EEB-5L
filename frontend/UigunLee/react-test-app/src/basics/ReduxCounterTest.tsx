...
import { RootState, increment, decrement } from "../state/stort.ts";
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-6 rounded-2xl shadow-md text-center space-y-4">
                <h1 className="text-2xl font-bold">Redux Based Counter</h1>
                ...
                <div className="flex gap-4 justify-center">
                    ...
                    <button
                        ...
                        className="w-12 h-12 bg-red-500 hover:bg-red-600 text-white text-2xl font-bold rounded-lg shadow thansition">
                        -
                    </button>
                </div>
            </div>
