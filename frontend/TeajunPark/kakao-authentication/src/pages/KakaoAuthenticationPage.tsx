...
const KakaoAuthenticationPage: React.FC = () => {
    ...
    const handleKakaoLogin = () => {
        ...
        const receiveMessage = (event: MessageEvent) => {
            ...
            // 해당 파트에 보면 userToken이 생성되어 있는 것을 볼 수 있다.
    ...
    return (
        // Box는 React MUI (Vue Vuetify)에 해당하는 UI 탬플릿입니다.
        // <div> 태그에 해당하며 스타일을 조금 더 편리하게 지정 할 수 있도록 도와줍니다.
        // p: 4 <- 내부 여백(padding(을 1당 8px로 4는 32px 이다.
        // maxWidth: 400 <- 최대 너비는 400px로 제한한다.
        // margin: "0 auto" <- 가운데 정렬
        <Box sx={{ p: 4, maxWidth: 400, margin: "0 auto" }}>
            {/*
                Typography는 텍스트를 표현하는 볼드
                variant="h5" <_ HTML의 <h5>처럼 스타일링 하세요.
