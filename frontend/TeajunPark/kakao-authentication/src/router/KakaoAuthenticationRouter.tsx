...
const KakaoAuthenticationRouter = () => {
    return (
        // Suspense의 경우 로딩이 느리게 될 경우 멈춰 있는 것 보다는 특정 상황을 표현해주거나 메시지를 출력해서 사이트가 멈추지 않았음을 알려주려고 사용합니다.
        // 지금 여기서는 fallback에 <div> 블록을 배치해서 `로딩중...` 메시지가 출력되게 만들었습니다.
        <Suspense fallback={<div>로딩중 ........</div>}>
        {/* Routes를 통해 내부에 배치할 URI 경로 설정들을 준비 */}
            <Routes>
        {/* Routes를 통해 실제 어떤 URI로 이동할 때 어떤 컴포넌트를 사용할지 결정합니다. */}
