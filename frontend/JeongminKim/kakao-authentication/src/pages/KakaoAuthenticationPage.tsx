...
const KakaoAuthenticationPage: React.FC = () => {
    // 우리가 Routes로 감싸놓은 Route 설정을 활용할 수 있게 지원함
    ...
    const handleKakaoLogin = () => {
        ...
        const receiveMessage = (event: MessageEvent) => {
            ...
            // F12를 눌렀을 때 Application 파트에 localstorage가 보입니다.
            // 해당 파트에 보면 userToken이 생성되어 있는 것을 볼 수 있는데 아래 파트에서 작업하는 것이라 보면 되겠습니다.
        ...
        // 팝업으로 메시지가 전달되면 receiveMessage() 가 받으렴
    ...
    return (
        ...
        // maxWidth: 400 <- 최대 넓이 400px로 제한
        // margin: "0 auto" <- 가운데 정렬
        <Box sx={{ p: 4, maxWidth: 400, margin: "0 auto" }}>
            {/*
                Typography는 텍스트를 표현하는 필드
                variant="h5" <- HTML의 <h5>처럼 스타일링하세요
            ...
            */}
            ...
            {/* 
                SocialLoginButton은 사실상 또 다른 컴포넌트 
                컴포넌트 내부에서 또 다른 컴포넌트를 사용할 수 있다.
                provider는 실제 SocialLoginButton이 사용하는 파라미터
                provider를 사용하는 이유는 "kakao" 로그인임을 명시하기 위함입니다.
                onClick도 SocialLoginButton이 사용하는 파라미터
