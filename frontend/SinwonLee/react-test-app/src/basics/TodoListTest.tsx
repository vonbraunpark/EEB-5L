...
const TodoListTest = () => {
    ...
    return (
        // Background 배경
        <div className="min-h-screen flex bg-gradient-to-br from-blue-50
         to-purple-100 items-center justify-center px-4">
            {/* 배경에 박혀 있는 카드 */}
            <div className="bg-white shadow-2xl rounded-3xl w-full max-w-xl p-8">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <button
                        ...
                        className="shrink-0 bg-blue-600 text-white py-2 rounded-lg
                    ...
                    { taskList.map((task) => (
                        ...
                        <li
                            ...
                            className="flex justify-between items-center
                             bg-gray-50 border rounded-lg px-4 py-2 shadow-sm"
                        >
                            <span>{ task.text }</span>
                            <button
